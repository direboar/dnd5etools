...
const ScrapingMonsterJsonParser_1 = require("./ScrapingMonsterJsonParser");
const UdonariumCharacter2XML_1 = require("../../utils/UdonariumCharacter2XML");
const CharacterZipFlieCreator_1 = require("../../utils/CharacterZipFlieCreator");
test('hello', async () => {
    const filePath = "./files/srd_5e_monsters.json";
    const monstars = new ScrapingMonsterJsonParser_1.ScrapingMonsterJsonParser().parse(filePath);
    const monstar2UdonarimuCharacter = new Monstar2UdonarimuCharacter_1.Monstar2UdonarimuCharacter();
    const udonariumCharacter = monstar2UdonarimuCharacter.convert(monstars[0]);
    const builder = new UdonariumCharacter2XML_1.UdonariumCharacter2XML();
    const xml = builder.buildXml(udonariumCharacter);
    const zipCreator = new CharacterZipFlieCreator_1.CharacterZipFlieCreator(udonariumCharacter, monstars[0].imageUrl);
...
//# sourceMappingURL=ScrapingMonsterJsonParser.test.js.map